...
public class BatchOfProductCreationDTO   {
  ...
  public BatchOfProductCreationDTO expirationDateStart(OffsetDateTime expirationDateStart) {
  ...
  public BatchOfProductCreationDTO expirationDateEnd(OffsetDateTime expirationDateEnd) {
