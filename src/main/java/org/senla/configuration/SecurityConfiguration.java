...
import static org.senla.model.RoleEnum.*;
        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers(GET, "/api/v1/batch/**").hasAnyAuthority(SUPER_ADMIN_READ.name())
                                .requestMatchers(POST, "/api/v1/batch/**").hasAnyAuthority(SUPER_ADMIN_CREATE.name())
                                .requestMatchers(PATCH, "/api/v1/batch/**").hasAnyAuthority(SUPER_ADMIN_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/batch/**").hasAnyAuthority(SUPER_ADMIN_DELETE.name())
                                ...
                                .requestMatchers(GET, "/api/v1/product/**").hasAnyAuthority(SUPER_ADMIN_READ.name())
                                .requestMatchers(POST, "/api/v1/product/**").hasAnyAuthority(SUPER_ADMIN_CREATE.name())
                                .requestMatchers(PATCH, "/api/v1/product/**").hasAnyAuthority(SUPER_ADMIN_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/product/**").hasAnyAuthority(SUPER_ADMIN_DELETE.name())
                                ...
                                .requestMatchers(GET, "/api/v1/user/**").hasAnyAuthority(SUPER_ADMIN_READ.name())
                                .requestMatchers(POST, "/api/v1/user/**").hasAnyAuthority(SUPER_ADMIN_CREATE.name())
                                .requestMatchers(PATCH, "/api/v1/user/**").hasAnyAuthority(SUPER_ADMIN_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/user/**").hasAnyAuthority(SUPER_ADMIN_DELETE.name())
                                .anyRequest()
                                .authenticated()
                )
